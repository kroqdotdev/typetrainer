  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        >{`(function(){try{var d=document.documentElement,c=d.classList;c.remove('light','dark');var e=localStorage.getItem('theme');if(e==='system'||!e){var m=window.matchMedia('(prefers-color-scheme:dark)').matches;c.add(m?'dark':'light')}else{c.add(e)}}catch(e){}})();`}</Script>
      </head>
      <body
